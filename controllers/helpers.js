    ...
    while (script_feed.length || user_posts.length) {
        ...
        if (script_feed[0] === undefined ||
            ...
            const feedIndex = _.findIndex(user.feedAction, function(o) { 
                return o && o.post && script_feed[0] && (o.post.equals ? o.post.equals(script_feed[0].id) : o.post === script_feed[0].id);
            });
            if (feedIndex != -1) {
                        ...
                        if (commentObject.new_comment) {
                            ...
                            if (commentIndex != -1) {
                                ...
                                if (commentObject.harmful) {
                                    script_feed[0].comments[commentIndex].harmful = true;
                                }
                ...
                // Check if this post has been harmful by the user. If true, update the post.
                if (user.feedAction[feedIndex].harmful) {
                    script_feed[0].harmful = true;
                    script_feed[0].harmfuls++;
                }
                // Check if this post has been shared by the user. If true, update the post.
                if (user.feedAction[feedIndex].shared) {
                    script_feed[0].shared = true;
