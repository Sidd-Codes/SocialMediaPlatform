...
const scriptSchema = new mongoose.Schema({
    ...
    shares: Number, // Indicates the number of shares on the post (randomly assigned in populate.js)
    harmfuls: Number, // Indicates the number of harmfuls on the post (randomly assigned in populate.js)
    ...
    comments: [new Schema({
        ...
        harmfuls: Number, // Indicates the number of likes on the comment (randomly assigned in populate.js)
        ...
        harmful: { type: Boolean, default: false }, // T/F; indicates if the comment is harmful by the user
    }, { versionKey: false })]
}, { versionKey: false });
