...
console.log(color_start, 'Attempting to connect to MongoDB...');
...
mongoose.connection.on('connected', () => {
    console.log(color_success, 'Successfully connected to MongoDB.');
});
...
mongoose.connection.on('disconnected', () => {
    console.log(color_error, 'Disconnected from MongoDB.');
});
...
console.log(color_start, 'Starting database population...');
